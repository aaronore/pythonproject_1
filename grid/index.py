...
class Window(tk.Tk):
    def __init__(self,**kwargs):
        ...
        ttk.Label(topFrame,text="BMI試算表",font=('Helvetica','20')).pack(pady=(80,20))
        ...
        ttk.Label(bottomFrame,text="身高(cm)",style='gridLabel.TLabel').grid(column=0,row=4,sticky=tk.E)
        ...
        clearBtn.grid(column=1,row=0,sticky=tk.W)
